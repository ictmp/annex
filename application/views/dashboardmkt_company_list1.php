...
<script>
    $(function () {
        $("#tblCompanyList").dataTable({
            "ajax": {
                "url": "<?php echo site_url('dashboardcompanylist_show'); ?>",
                "type": "POST",
            ...
            "columns": [
                {"data": "companyid",
                    "render": function ( data, type, full ) {
                        return "<button id=\"view_" + full['packageid'] + "\" class=\"btn btn-primary btn-xs\" onclick=\"viewPackage('" + btoa(full['companyid']) + "')\">View</button";
                    }, "className": "text-center", "orderable": false, "searchable": false},
                {"data": "companyname", "className": "text-left"},
                {"data": "contact"},
                {"data": "contactphone", "className": "text-center"},
    ...
    function viewPackage(companyid) {
        $('#tbl_listitem').empty();
